                ...
                case '>':
                    {
                        ...
                        if (!(file.size > validator.value)) {
                            errors.push(new Error('File size too small. Required size is atleast: ' + validator.value + ' bytes and the size of your file is: ' + file.size + ' bytes!'));
                        }
                        break;
                    }
                ...
                case '<=':
                    {
                        ...
                        if (!(file.size <= validator.value)) {
                            errors.push(new Error('File size too big. Required size is atmost: ' + validator.value + ' bytes and the size of your file is: ' + file.size + ' bytes!'));
                        }
                        break;
                    }
                ...
                case 'in':
                    {
                        ...
                        if (!valueArr.includes(file.type)) {
                            errors.push(new Error('File type ' + file.type + ' is not supported. Supported file types are: ' + validator.value));
                        }
                        break;
                    }
